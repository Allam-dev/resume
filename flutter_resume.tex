...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Abdulrahman Allam

        \vspace{5 pt}

        \normalsize
        \mbox{Qewaisna, Menofia, Egypt}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:abdelrhmnallam@gmail.com}{abdelrhmnallam@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+201028264418}{+20 1028 264 418}}%
        \kern 5.0 pt%
        % \AND%
        % \kern 5.0 pt%
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://www.linkedin.com/in/allam-dev/}{linkedin.com/in/allam-dev}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/allam-dev}{github.com/allam-dev}}%
    \end{header}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Faculty of Electronic Engineering, Menoufia University}, BS in Computer Science\end{twocolentry}
